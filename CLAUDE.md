...
title: "CLAUDE.md — frontmatter-only Claude Code bootstrap for Solon SFS"
...
entry_contract:
  run_sfs: "Use `.claude/commands/sfs.md` when installed, otherwise run `sfs <command>` or `sfs.cmd <command>` on Windows PowerShell/cmd."
